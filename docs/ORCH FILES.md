...
An `.orch` file is used to define a workflow using your DSL.
...
[Orch Includes](ORCH FILES/Orch Includes.md)
...
- Example: `trafficStage`, `responseMode`
...
- initialize the system (`on_start`)
- perform final tasks like reporting or cleanup (`on_end`)
...
[ORCH MEMORY](ORCH FILES/ORCH MEMORY.md)